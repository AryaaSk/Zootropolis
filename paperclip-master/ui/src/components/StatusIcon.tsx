...
// Phase V: backlog is dead — not selectable. The icon map (status-colors)
// still recognises it for display of legacy rows, but the picker no longer
// offers it as a transition target.
const allStatuses = ["todo", "in_progress", "in_review", "done", "cancelled", "blocked"];
